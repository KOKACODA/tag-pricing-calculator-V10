// ============================================================
// KOKALabel报价系统 v10.0.0 - 主程序（计算 + 渲染 + 交互 + 初始化）
// ============================================================
"use strict";
...
function renderSheets() {
  ...
  sheetsState.forEach((sheet, index) => {
    ...
    // v10.0.0：SKU 芯片直选——全称放 title 悬浮显示，高密度平铺
  ...
  // v10.0.0：SKU 芯片直选——仅绑定 .paper-option 点击，下拉/搜索交互已移除
