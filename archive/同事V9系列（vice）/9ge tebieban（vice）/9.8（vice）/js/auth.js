...
(function () {
  ...
  function renderTopBar() {
    ...
    // 注入到左侧导航栏菜单底部（v9.7.1 导航移至侧栏；保留旧结构兼容）
    const navInner = document.querySelector('nav.sidenav-menu') || document.querySelector('nav.nav-inner') || document.querySelector('header') || document.body;
