...
import { json, getUser, saveUser, listUsers, hashPassword, randomSalt, getSession, authToken, publicUser, normalizeRole } from '../../_lib.js';
...
export async function onRequestPost(context) {
  ...
  const user = {
    username, role,
    nickname: String(body.nickname || '').trim().slice(0, 30) || null,
